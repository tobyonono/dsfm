                ...
                <div className=" m-auto text-sm font-nitti mb-8 ">
                    <div className="grid grid-cols-2  m-auto">
                        <div className=" py-12 pr-12 text-left">
                            <h1 className="font-guyot italic text-6xl mb-4 ">Code of Practice - Complaints</h1>
                            <h1 className="font-GTWalsheim text-6xl "></h1>
                        </div>
                        <div className="py-12 pl-12 text-left font-GTWalsheim text-base">
                            <p className="mb-4">Under the Broadcasting Act 2009, viewers and listeners to Irish radio and
                                ...
                                it is about the broadcast that has led them to make a complaint.

                                Dublin South FM aims to deliver the best possible service to our listeners. We
                                ...
                                Dublin South FM is obliged under the Broadcasting Act, 2009 to have in place
                                ...
                                You may submit a complaint to us if you are of the opinion that a broadcast or
                                ...
                                What I can complain about?’ above) ·
                                 the date, time and channel of broadcast; ·
                                 the name of the programme, news item or advertisement/commercial
                                communication that you have viewed/heard and which is the subject of
                                your complaint;
                                ...
                                 if your complaint relates to one broadcast, 30 days after the date of that
                                broadcast;
                                 if your complaint relates to two or more unrelated broadcasts; 30 days
                                after the date of the earlier or earliest of those broadcasts;
                                 if your complaints relates to two or more related broadcasts of which at
                                ...
                                Dundrum Town Centre
                                Dublin 16
                                Contact Number: 01 296 0939
                                Email: complaints@dublinsouthfm.ie
                                ...
                                yourself should have heard the broadcast in question.</p>
                            ...
                            <div className="max-w-none text-base">
                                ...
                                <div className="text-left">
                                    <p className="mb-4">Under the Broadcasting Act 2009, viewers and listeners to Irish radio and
                                        ...
                                        <p> Dublin South FM is obliged under the Broadcasting Act, 2009 to have in place
                                        a Code of Practice for handling complaints from our listeners. This Code of
                                        Practice sets out and explains our complaint process for listeners and ensures
