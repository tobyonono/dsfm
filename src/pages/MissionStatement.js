    ...
    return (
        <div>
            <section className=" hidden h-full w-full p-8">
                <div className=" m-auto text-sm font-nitti mb-8 ">
                    <div className="grid grid-cols-2  m-auto">
                        <div className=" py-12 pr-12 text-left">
                            <h1 className="font-guyot italic text-6xl mb-4 ">Our</h1>
                            <h1 className="font-GTWalsheim text-6xl ">Mission</h1>
                        </div>
                        <div className="py-12 pl-12 text-left font-GTWalsheim text-base">
                            <p className="mb-4">Dublin South Community Radio, 93.9 is a non-profit entity operating under the auspices of the Broadcasting Authority of Ireland (BAI).
                ...
                <div className=" text-left grid grid-cols-3 gap-4 m-auto">
                    <div className="shadow-lg rounded-3xl p-3 border border-2">
                        <h1 className="font-guyot text-xl mb-4 ">01</h1>
                        <h1 className="font-guyot text-4xl mb-4 ">Provide</h1>
                    ...
                    <div className="shadow-lg rounded-3xl p-3 border border-2">
                        ...
                        <h1 className="font-guyot text-4xl mb-4 ">Serve</h1>
                    ...
                    <div className="shadow-lg rounded-3xl p-3 border border-2">
                        ...
                        <h1 className="font-guyot text-4xl mb-4 ">Work</h1>
                    ...
                    <div className="shadow-lg rounded-3xl p-3 border border-2">
                        ...
                        <h1 className="font-guyot  text-4xl mb-4 ">Foster</h1>
                    ...
                    <div className="shadow-lg rounded-3xl p-3 border border-2">
                        ...
                        <h1 className="font-guyot  text-4xl mb-4 ">Defend</h1>
                    ...
                    <div className="shadow-lg rounded-3xl p-3 border border-2">
                        ...
                        <h1 className="font-guyot  text-4xl mb-4 ">Ensure</h1>
                    ...
                    <div className="shadow-lg rounded-3xl p-3 border border-2">
                        ...
                        <h1 className="font-guyot  text-4xl mb-4 ">Support</h1>
                    ...
                    <div className="shadow-lg rounded-3xl p-3 border border-2">
                        ...
                        <h1 className="font-guyot  text-4xl mb-4 ">Encourage</h1>
                    ...
                    <div className="shadow-lg rounded-3xl p-3 border border-2">
                        ...
                        <h1 className="font-guyot  text-4xl mb-4 ">Resist</h1>
                    ...
                    <div className="shadow-lg rounded-3xl p-3 border border-2">
                        ...
                        <h1 className="font-guyot  text-4xl mb-4 ">Promote</h1>
