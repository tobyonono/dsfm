...
<footer class="p-4 bg-black sm:p-6 font-nitti uppercase">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">Dublin South FM™</a>. All Rights Reserved.
        </span>
